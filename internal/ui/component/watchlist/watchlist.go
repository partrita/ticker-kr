...
func (m *Model) View() string {
	...
	// Grow with a conservative estimate: 3 lines per row * width + newlines.
	// The factor of 3 accounts for ANSI escape codes and multiple lines of text per row.
	b.Grow(len(m.rows) * (m.width + 1) * 3)
